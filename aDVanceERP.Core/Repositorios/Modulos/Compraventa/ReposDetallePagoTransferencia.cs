...
public class RepoDetallePagoTransferencia : RepoEntidadBaseDatos<DetallePagoTransferencia, FiltroBusquedaDetallePagoTransferencia> {
    ...
    protected override string GenerarComandoAdicionar(DetallePagoTransferencia objeto) {
        return $"""
            INSERT INTO adv__detalle_pago_transferencia (
                ...
                {objeto.IdVenta}, 
                {objeto.IdTarjeta}, 
                '{objeto.NumeroConfirmacion}', 
                '{objeto.NumeroTransaccion}'
            );
            """;
    }
    ...
    protected override string GenerarComandoEditar(DetallePagoTransferencia objeto) {
        return $"""
            ...
            SET 
                ...
                id_tarjeta = {objeto.IdTarjeta}, 
                numero_confirmacion = '{objeto.NumeroConfirmacion}', 
                numero_transaccion = '{objeto.NumeroTransaccion}' 
    ...
    protected override string GenerarComandoEliminar(long id) {
        return $"""
            ...
            WHERE id_detalle_pago_transferencia = {id};
            """;
    }

    protected override string GenerarComandoObtener(FiltroBusquedaDetallePagoTransferencia filtroBusqueda, string dato) {
        ...
        switch (filtroBusqueda) {
            case FiltroBusquedaDetallePagoTransferencia.Id:
                comando = $"""
                    ...
                    WHERE id_detalle_pago_transferencia = {dato};
                    """;
                break;
