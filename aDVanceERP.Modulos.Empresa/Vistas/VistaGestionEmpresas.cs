...
namespace aDVanceERP.Modulos.Empresa.Vistas {
    public partial class VistaGestionEmpresas : Form, IVistaGestionEmpresas {
        private int _paginaActual = 1;
        private int _paginasTotales = 1;

        public VistaGestionEmpresas() {
            InitializeComponent();

            NombreVista = nameof(VistaGestionEmpresas);
        ...
        public FiltroBusquedaEmpresa FiltroBusqueda {
            get => fieldFiltroBusqueda.SelectedIndex >= 0
                ? (FiltroBusquedaEmpresa) fieldFiltroBusqueda.SelectedIndex
                : default;
        ...
        public event EventHandler<(FiltroBusquedaEmpresa, string[])>? BuscarEntidades;
