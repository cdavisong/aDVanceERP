...
public class PresentadorRegistroMensajero : PresentadorVistaRegistro<IVistaRegistroMensajero, Mensajero, RepoMensajero, FiltroBusquedaMensajero> {
    ...
    protected override bool EntidadCorrecta() {
        ...
        if (!telefonoOk)
            CentroNotificaciones.Mostrar("EL campo del teléfono móvil es obligatorio para el mensajero, rellene los datos necesarios de forma correcta y proceda al registro", TipoNotificacion.Advertencia);
