...
public partial class VistaGestionContactos : Form, IVistaGestionContactos {
    ...
    public VistaGestionContactos() {
        ...
        NombreVista = nameof(VistaGestionContactos);
    ...
    public FiltroBusquedaContacto FiltroBusqueda {
        get => fieldFiltroBusqueda.SelectedIndex >= 0
            ? (FiltroBusquedaContacto)fieldFiltroBusqueda.SelectedIndex
            : default;
    ...
    public event EventHandler<(FiltroBusquedaContacto, string?)>? BuscarEntidades;
