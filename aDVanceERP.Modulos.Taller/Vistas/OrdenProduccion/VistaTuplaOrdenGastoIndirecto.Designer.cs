...
namespace aDVanceERP.Modulos.Taller.Vistas.OrdenProduccion {
    partial class VistaTuplaOrdenGastoIndirecto {
        /// <summary>
        ...
        private void InitializeComponent() {
            ...
            ComponentResourceManager resources = new ComponentResourceManager(typeof(VistaTuplaOrdenGastoIndirecto));
            ...
            layoutVista.Controls.Add(fieldConceptoGasto, 0, 0);
            ...
            fieldMonto.CustomizableEdges = customizableEdges1;
            ...
            fieldMonto.Location = new Point(200, 3);
            ...
            fieldMonto.ShadowDecoration.CustomizableEdges = customizableEdges2;
            fieldMonto.Size = new Size(124, 35);
            fieldMonto.TabIndex = 5;
            ...
            // fieldConceptoGasto
            // 
            fieldConceptoGasto.AutoEllipsis = true;
            fieldConceptoGasto.Dock = DockStyle.Fill;
            fieldConceptoGasto.Font = new Font("Segoe UI", 11.25F);
            fieldConceptoGasto.ForeColor = Color.DimGray;
            fieldConceptoGasto.ImeMode = ImeMode.NoControl;
            fieldConceptoGasto.Location = new Point(1, 1);
            fieldConceptoGasto.Margin = new Padding(1);
            fieldConceptoGasto.Name = "fieldConceptoGasto";
            fieldConceptoGasto.Size = new Size(195, 39);
            fieldConceptoGasto.TabIndex = 1;
            fieldConceptoGasto.Text = "conceptoGasto";
            fieldConceptoGasto.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // fieldCantidad
            // 
            ...
            Name = "VistaTuplaOrdenGastoIndirecto";
            ShowIcon = false;
            ShowInTaskbar = false;
        ...
        private Label fieldConceptoGasto;
