...
namespace aDVanceERP.Modulos.Inventario.Vistas {
    public partial class VistaGestionUnidadesMedida : Form, IVistaGestionUnidadesMedida {
        private int _paginaActual = 1;
        private int _paginasTotales = 1;

        public VistaGestionUnidadesMedida() {
            InitializeComponent();

            NombreVista = nameof(VistaGestionUnidadesMedida);
        ...
        public FiltroBusquedaUnidadMedida FiltroBusqueda {
            get => fieldFiltroBusqueda.SelectedIndex >= 0
                ? (FiltroBusquedaUnidadMedida) fieldFiltroBusqueda.SelectedIndex
                : default;
        ...
        public event EventHandler<(FiltroBusquedaUnidadMedida, string[])>? BuscarEntidades;
