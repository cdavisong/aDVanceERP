...
namespace aDVanceERP.Modulos.Inventario.Vistas {
    public partial class VistaGestionClasificaciones : Form, IVistaGestionClasificaciones {
        private int _paginaActual = 1;
        private int _paginasTotales = 1;

        public VistaGestionClasificaciones() {
            InitializeComponent();

            NombreVista = nameof(VistaGestionClasificaciones);
        ...
        public FiltroBusquedaClasificacionProducto FiltroBusqueda {
            get => fieldFiltroBusqueda.SelectedIndex >= 0
                ? (FiltroBusquedaClasificacionProducto) fieldFiltroBusqueda.SelectedIndex
                : default;
        ...
        public event EventHandler<(FiltroBusquedaClasificacionProducto, string[])>? BuscarEntidades;
