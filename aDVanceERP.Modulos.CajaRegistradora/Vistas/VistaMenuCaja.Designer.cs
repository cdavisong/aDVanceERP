...
namespace aDVanceERP.Modulos.CajaRegistradora.Vistas {
    partial class VistaMenuCaja {
        ...
        private void InitializeComponent() {
            ...
            panelRelleno.Controls.Add(btnCaja);
            ...
            // btnCaja
            // 
            btnCaja.Animated = true;
            btnCaja.BackColor = Color.WhiteSmoke;
            btnCaja.ButtonMode = Guna.UI2.WinForms.Enums.ButtonMode.RadioButton;
            btnCaja.CheckedState.FillColor = Color.WhiteSmoke;
            btnCaja.CheckedState.Font = new Font("Segoe UI", 11.25F, FontStyle.Bold);
            btnCaja.CustomImages.CheckedImage = Properties.Resources.barra_seleccion;
            btnCaja.CustomImages.ImageAlign = HorizontalAlignment.Center;
            btnCaja.CustomImages.ImageOffset = new Point(0, 32);
            btnCaja.CustomImages.ImageSize = new Size(131, 8);
            btnCaja.CustomizableEdges = customizableEdges1;
            btnCaja.Dock = DockStyle.Left;
            btnCaja.FillColor = Color.WhiteSmoke;
            btnCaja.Font = new Font("Segoe UI", 11.25F);
            btnCaja.ForeColor = Color.Black;
            btnCaja.Location = new Point(0, 0);
            btnCaja.Margin = new Padding(0);
            btnCaja.Name = "btnCaja";
            btnCaja.ShadowDecoration.CustomizableEdges = customizableEdges2;
            btnCaja.Size = new Size(140, 50);
            btnCaja.TabIndex = 17;
            btnCaja.Text = "Turno";
            // 
            // VistaMenuCaja
