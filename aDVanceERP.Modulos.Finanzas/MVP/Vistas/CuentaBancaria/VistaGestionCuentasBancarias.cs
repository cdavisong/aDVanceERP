...
public partial class VistaGestionCuentasBancarias : Form, IVistaGestionCuentasBancarias {
    ...
    public VistaGestionCuentasBancarias() {
        InitializeComponent();

        NombreVista = nameof(VistaGestionCuentasBancarias);
    ...
    public FiltroBusquedaCuentaBancaria FiltroBusqueda {
        get => fieldFiltroBusqueda.SelectedIndex >= 0
            ? (FiltroBusquedaCuentaBancaria)fieldFiltroBusqueda.SelectedIndex
            : default;
