...
namespace aDVanceERP.Modulos.Seguridad.Vistas {
    public partial class VistaAutenticacionCuentaUsuario : Form, IVistaAutenticacionUsuario {
        public VistaAutenticacionCuentaUsuario() {
            InitializeComponent();

            NombreVista = nameof(VistaAutenticacionCuentaUsuario);
        ...
        public void Inicializar() {
            ...
            fieldPassword.KeyDown += delegate (object? sender, KeyEventArgs args) {
                if (args.KeyCode == Keys.Enter) {
                    AgregadorEventos.Publicar(new EventoAutenticarCuentaUsuario() { 
            ...
            btnRegistrarCuenta.Click += delegate (object? sender, EventArgs e) {
                AgregadorEventos.Publicar(new EventoMostrarVistaRegistroCuentaUsuarioLogin());
                Ocultar();
            };
        }
