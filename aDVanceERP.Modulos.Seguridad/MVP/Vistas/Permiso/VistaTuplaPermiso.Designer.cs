...
namespace aDVanceERP.Modulos.Seguridad.MVP.Vistas.Permiso {
    partial class VistaTuplaPermiso {
        /// <summary>
        ...
        private void InitializeComponent() {
            ...
            layoutVista.ColumnCount = 2;
            layoutVista.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F));
            layoutVista.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 40F));
            layoutVista.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 20F));
            layoutVista.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 20F));
            layoutVista.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 20F));
            layoutVista.Controls.Add(btnEliminar, 1, 0);
            layoutVista.Controls.Add(fieldNombrePermiso, 0, 0);
            ...
            fieldNombrePermiso.Margin = new Padding(1);
        ...
        private Label fieldNombrePermiso;
    }
}