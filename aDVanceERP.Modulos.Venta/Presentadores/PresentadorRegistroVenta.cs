...
namespace aDVanceERP.Modulos.Venta.Presentadores {
    public class PresentadorRegistroVenta : PresentadorVistaRegistro<IVistaRegistroVenta, Core.Modelos.Modulos.Ventas.Venta, RepoVenta, FiltroBusquedaVenta> {
        ...
        private void OnMostrarVistaEdicionVenta(string obj) {
            ...
            var venta = AgregadorEventos.DeserializarPayload<Core.Modelos.Modulos.Ventas.Venta>(obj);
        ...
        public override void PopularVistaDesdeEntidad(Core.Modelos.Modulos.Ventas.Venta entidad) {
            base.PopularVistaDesdeEntidad(entidad);

            
        }

        protected override Core.Modelos.Modulos.Ventas.Venta? ObtenerEntidadDesdeVista() {
