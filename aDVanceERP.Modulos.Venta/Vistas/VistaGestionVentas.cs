...
namespace aDVanceERP.Modulos.Venta.Vistas {
    public partial class VistaGestionVentas : Form, IVistaGestionVentas {
        ...
        public decimal TotalRecaudado {
            get => _totalRecaudado;
            set {
                _totalRecaudado = value;

                fieldTotalRecaudado.Text = $"$ {value.ToString("N2", CultureInfo.InvariantCulture)}";
            }
        }
        ...
        public void Inicializar() {
            ...
            fieldCriterioBusqueda.KeyDown += delegate (object? sender, KeyEventArgs args) {
                ...
                if (CriteriosBusqueda.Length > 0 && !string.IsNullOrEmpty(CriteriosBusqueda[0]))
                    BuscarEntidades?.Invoke(this, (FiltroBusqueda, new[] { fieldFiltroBusquedaFechaDesde.Value.ToString("yyyy-MM-dd 00:00:00"), fieldFiltroBusquedaFechaHasta.Value.ToString("yyyy-MM-dd 23:59:59"), CriteriosBusqueda[0], "Venta" }));
