...
namespace aDVanceERP.Modulos.RecursosHumanos.Vistas {
    public partial class VistaGestionEmpleados : Form, IVistaGestionEmpleados {
        ...
        public FiltroBusquedaEmpleado FiltroBusqueda {
            get => fieldFiltroBusqueda.SelectedIndex >= 0
                ? (FiltroBusquedaEmpleado) fieldFiltroBusqueda.SelectedIndex
                : default;
        ...
        public event EventHandler<(FiltroBusquedaEmpleado, string[])>? BuscarEntidades;
        ...
        public void Restaurar() {
            ...
            btnActivarDesactivarEmpleado.Hide();
            fieldFiltroBusqueda.SelectedIndex = 0;
        }
        ...
        private void VerificarPermisos() {
            ...
            btnRegistrar.Enabled = (ContextoSeguridad.UsuarioAutenticado?.Administrador ?? false)
                                   || ContextoSeguridad.PermisosUsuario.ContienePermisoExacto("MOD_RRHH_CLIENTES_ADICIONAR")
