...
public partial class VistaGestionPersonas : Form, IVistaGestionPersonas {
    ...
    public VistaGestionPersonas() {
        ...
        NombreVista = nameof(VistaGestionPersonas);
    ...
    public FiltroBusquedaPersona FiltroBusqueda {
        get => fieldFiltroBusqueda.SelectedIndex >= 0
            ? (FiltroBusquedaPersona) fieldFiltroBusqueda.SelectedIndex
            : default;
    ...
    public event EventHandler<(FiltroBusquedaPersona, string[])>? BuscarEntidades;
    ...
    public void Inicializar() {
        ...
        // Eventos
        AgregadorEventos.Suscribir("ResultadosBusquedaActualizados", OcultarMostrarBotonActivarDesactivarPersona);
        AgregadorEventos.Suscribir("CambioSeleccionTuplaEntidad", OcultarMostrarBotonActivarDesactivarPersona);
        ...
        btnActivarDesactivarPersona.Click += delegate (object? sender, EventArgs e) {
            AgregadorEventos.Publicar("ActivarDesactivarPersona", string.Empty);
        };
    ...
    private void OcultarMostrarBotonActivarDesactivarPersona(string obj) {
        ...
        try {
            ...
            btnActivarDesactivarPersona.Visible = visibilidadBoton;
    ...
    public void Restaurar() {
        ...
        btnActivarDesactivarPersona.Hide();
        fieldFiltroBusqueda.SelectedIndex = 0;
    }
