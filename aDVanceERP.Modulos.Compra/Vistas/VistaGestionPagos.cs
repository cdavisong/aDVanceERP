...
namespace aDVanceERP.Modulos.Compra.Vistas {
    public partial class VistaGestionPagos : Form, IVistaGestionPagos {
        ...
        public VistaGestionPagos() {
            ...
            NombreVista = $"{nameof(VistaGestionPagos)}Compra";
        ...
        public void Inicializar() {
            ...
            fieldCriterioBusqueda.KeyDown += delegate (object? sender, KeyEventArgs args) {
                ...
                if (CriteriosBusqueda.Length > 0 && !string.IsNullOrEmpty(CriteriosBusqueda[0]))
                    BuscarEntidades?.Invoke(this, (FiltroBusqueda, new[] { fieldFiltroBusquedaFechaDesde.Value.ToString("yyyy-MM-dd"), fieldFiltroBusquedaFechaHasta.Value.ToString("yyyy-MM-dd"), CriteriosBusqueda[0], "Compra" }));
