...
namespace aDVanceERP.Modulos.Compra.Vistas {
    public partial class VistaGestionSolicitudesCompra : Form, IVistaGestionSolicitudesCompra {
        private int _paginaActual = 1;
        private int _paginasTotales = 1;

        public VistaGestionSolicitudesCompra() {
            InitializeComponent();

            NombreVista = nameof(VistaGestionSolicitudesCompra);
        ...
        public FiltroBusquedaSolicitudCompra FiltroBusqueda {
            get => fieldFiltroBusqueda.SelectedIndex >= 0
                ? (FiltroBusquedaSolicitudCompra) fieldFiltroBusqueda.SelectedIndex
                : default;
        ...
        public event EventHandler<(FiltroBusquedaSolicitudCompra, string[])>? BuscarEntidades;
