...
namespace aDVanceERP.Modulos.Compra.Vistas {
    partial class VistaGestionProveedores {
        ...
        private void InitializeComponent() {
            ...
            layoutVista.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 20F));
            layoutVista.Controls.Add(layoutHelp, 2, 3);
            layoutVista.Controls.Add(layoutHerramientas, 2, 6);
            layoutVista.Controls.Add(layoutTituloHerramientas, 2, 5);
            layoutVista.Controls.Add(layoutControlesTabla, 2, 13);
            layoutVista.Controls.Add(layoutTitulo, 2, 1);
            layoutVista.Controls.Add(fieldIcono, 1, 1);
            layoutVista.Controls.Add(contenedorVistas, 2, 12);
            layoutVista.Controls.Add(panelBotonesGestion, 2, 8);
            ...
            fieldSubtitulo.Text = "Registro, edición, eliminación, búsqueda de proveedores.";
            // 
